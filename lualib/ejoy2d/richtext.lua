...
M.operates = {
	...
	r			={val=0xFFFB0101,type="color"},
	y			={val=0xFFFBF801,type="color"},
	g1			={val=0xFF01FB13,type="color"},
	g2			={val=0xFF1D8904,type="color"},
	b			={val=0xFF000000,type="color"},
	b1			={val=0xFF0142FB,type="color"},
	b2			={val=0xFF01C9FB,type="color"},
	o			={val=0xFFFF9806,type="color"},
	p			={val=0xFFCD06FF,type="color"},
	w			={val=0xFFFFFFFF,type="color"},
	stop			={type="ctl"},
}
