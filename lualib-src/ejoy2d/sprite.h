...
void sprite_drawquad(struct pack_picture *picture, int *dynamic_tex, const struct srt *srt, const struct sprite_trans *arg);
...
int sprite_child_index(struct sprite *parent, struct sprite *child);
struct sprite_trans * sprite_complete_trans(struct sprite *s, struct sprite_trans *temp, struct matrix *temp_matrix);
...
const char * sprite_dynamic_tex(struct sprite * s);
